            ...
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    @if(auth()->user()->role === 'admin')
                        ...
                        <x-nav-link :href="route('admin.meja.index')" :active="request()->routeIs('admin.meja.index')">
                            {{ __('Meja') }}
                        </x-nav-link>
...
{{-- Diubah menjadi kasir.pos* agar mencakup input DAN edit --}}
<x-nav-link :href="route('kasir.pos.input')" :active="request()->routeIs('kasir.pos*')">
    {{ __('Transaksi') }}
</x-nav-link>
                ...
                <x-dropdown align="right" width="48">
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            ...
                            <div class="w-8 h-8 rounded-full bg-blue-600 flex items-center justify-center text-white font-bold text-xs shadow-sm mr-2">
